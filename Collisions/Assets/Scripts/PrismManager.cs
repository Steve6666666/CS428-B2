...
public class PrismManager : MonoBehaviour
{
        ...
        public class Shapes
    {
        ...
        public Shapes(int id,float left_x,float right_x,float left_z,float right_z)
        {
            this.id = id;
            this.left_x = left_x;
    ...
    private IEnumerable<PrismCollision> PotentialCollisions()
    {
        ...
        foreach (var prism in prisms)
        {
            ...
            Shapes a = new Shapes(Int32.Parse(prism.name.Substring(6)), left_x, right_x, left_z, right_z);
            shapes.Add(a);
            //a.printout();
        }
       ...
       collisionPairsZ.ForEach((float[] a) => print("z-axis" + a[0] + " and " + a[1]));
        ...
        {
            if (collisionPairsZ.Any(a=>a.SequenceEqual(i))|| collisionPairsZ.Any(a => a.SequenceEqual(new float[] {i[1],i[0] })))
            {
